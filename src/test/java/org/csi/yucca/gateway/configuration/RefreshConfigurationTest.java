...
public class RefreshConfigurationTest extends AbstractIntegrationTest {
	...
	public void testRefreshConfiguration() {
		...
		int numeroStream = JdbcTestUtils.countRowsInTable(jdbcTemplate, "STREAM_METADATA_CONFIGURATION");
		...
		int numeroStreamDopo = JdbcTestUtils.countRowsInTable(jdbcTemplate, "STREAM_METADATA_CONFIGURATION");

		Assert.assertEquals(numeroStream+2, numeroStreamDopo);
		...
		int numeroStreamDopoDopo = JdbcTestUtils.countRowsInTable(jdbcTemplate, "STREAM_METADATA_CONFIGURATION");

		Assert.assertEquals(numeroStreamDopo, numeroStreamDopoDopo);
